      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <div className="inline-block mb-4">
            <span className="px-5 py-2 bg-gradient-to-r from-maroon-50 to-gold-100 text-maroon-600 font-semibold rounded-full text-sm tracking-wide shadow-sm">
              Our Legacy
            </span>
          </div>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 text-gray-900">
            A <span className="text-maroon-600">Tradition</span> of Excellence
          </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center p-8 md:p-12">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="px-4 py-2 bg-gradient-to-r from-maroon-400 to-maroon-700 text-white font-semibold rounded-full text-sm shadow-md">
                    1994
                  </div>
                </div>
                ...
                <p className="text-lg text-maroon-600 mt-4 font-medium">
        ...
        <div className="mb-20">
          ...
          <div className="text-center mb-12">
            <div className="inline-block mb-4 px-6 py-2 bg-gradient-to-r from-maroon-50 to-gold-100 rounded-full shadow-sm">
              <span className="text-maroon-600 font-semibold text-sm tracking-wide">Historic Battles</span>
            </div>
            <h3 className="text-3xl sm:text-4xl font-bold text-gray-900">
              <span className="text-maroon-600">Legendary</span> Moments
            </h3>
            <div className="w-24 h-1 bg-gradient-to-r from-maroon-400 to-maroon-700 mx-auto mt-4 rounded-full" />
          </div>
            ...
            {historicMoments.slice(1).map((moment) => (
              ...
              >
                ...
                <div className="relative">
                  {/* Icon badge - top left */}
                  <div className="absolute top-4 left-4 z-20 w-16 h-16 bg-gradient-to-br from-maroon-400 to-maroon-700 rounded-xl flex items-center justify-center shadow-lg">
                    <div className="text-4xl">{moment.icon}</div>
                  </div>

                  {/* Year badge - top right */}
                  <div className="absolute top-4 right-4 z-20">
                    <div className="px-4 py-2 bg-gradient-to-r from-maroon-400 to-maroon-700 text-white font-semibold text-sm rounded-full shadow-md">
                      {moment.year}
                    </div>
                  </div>
                  ...
                  <div className="p-8 bg-white">
                    <h4 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-900 group-hover:text-maroon-600 transition-colors">
                      {moment.title}
                    </h4>
                    <div className="w-16 h-1 bg-maroon-500 mb-4 rounded-full" />
                    ...
                    <button
                      ...
                      className="w-full px-6 py-3.5 bg-gradient-to-r from-maroon-500 to-maroon-700 hover:from-maroon-600 hover:to-gold-700 text-white font-semibold rounded-lg transition-all duration-300 shadow-md hover:shadow-lg mt-6"
                    >
                      Read Full Story
                    </button>
                  </div>
        ...
        <div className="mt-16 text-center max-w-4xl mx-auto bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-lg border border-gray-200">
          <div className="relative">
            <div className="text-8xl text-maroon-400/20 absolute -top-8 left-0">"</div>
            ...
            <div className="text-8xl text-maroon-400/20 absolute -bottom-8 right-0">"</div>
          </div>
          <div className="mt-8">
            <p className="text-xl text-maroon-600 font-semibold">— Aquinas Boxing Coaching Staff</p>
        ...
        <div className="mt-16 text-center bg-white rounded-2xl p-8 border border-gray-200 shadow-lg">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-maroon-500 to-maroon-700 hover:from-maroon-600 hover:to-gold-700 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg"
          >
        ...
        >
          ...
          >
            ...
            <div className="p-8 md:p-12">
              {/* Header */}
              <div className="mb-8">
                <div className="inline-block px-4 py-2 bg-gradient-to-r from-maroon-400 to-maroon-700 rounded-full text-white font-semibold text-sm shadow-md mb-4">
                  <span>1932</span>
                </div>
                <h3 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">
                  The Mission Bouts Origin Story
                </h3>
                <div className="w-24 h-1 bg-gradient-to-r from-maroon-400 to-maroon-700 rounded-full" />
              </div>

              {/* Full Story Content */}
              <div className="space-y-6 text-gray-700 leading-relaxed">
                <p className="text-xl font-semibold text-gray-900 border-l-4 border-gold-500 pl-6 bg-maroon-50 py-3 rounded-r-lg">
                ...
                <p className="text-xl font-semibold text-gray-900 border-l-4 border-gold-500 pl-6 bg-maroon-50 py-3 rounded-r-lg mt-8">
                ...
                <p className="text-lg text-maroon-600 font-semibold text-center mt-8">
