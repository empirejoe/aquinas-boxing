      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              Building champions in the ring and in life through discipline, respect, 
              and perseverance. Home of the legendary Mission Bouts.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#streaming" className="text-gray-400 hover:text-white transition-colors">
                  Streaming
                </a>
              </li>
              <li>
                <a href="#swag-store" className="text-gray-400 hover:text-white transition-colors">
                  Store
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <a href="tel:+15852542020" className="flex items-center gap-2 hover:text-white transition-colors">
                  <svg className="w-5 h-5 text-maroon-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span className="text-sm">(585) 254-2020</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <p className="text-gray-400 text-sm text-center">
            &copy; {new Date().getFullYear()} Aquinas Institute Boxing Program. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
