...
export default function SocialFeed() {
  ...
  return (
    <section id="social" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-block mb-4 px-6 py-2 bg-maroon-900 border-2 border-gold-500">
            <span className="text-gold-400 font-black text-sm uppercase tracking-widest">Stay Connected</span>
          </div>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8 font-bold">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-wide transition-all duration-300 transform hover:scale-105 shadow-xl border-2 border-blue-800"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-black uppercase tracking-wide transition-all duration-300 transform hover:scale-105 shadow-xl border-2 border-purple-800"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          {/* Facebook Feed Embed */}
          <div className="bg-gradient-to-br from-gray-900 to-black p-6 border-2 border-neutral-800 shadow-xl">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-gold-500">
              ...
              <div>
                <h3 className="text-xl font-black text-white uppercase">Facebook Feed</h3>
                <p className="text-sm text-gold-400 font-bold">@AquinasMissionBouts</p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-gray-900 to-black p-6 border-2 border-neutral-800 shadow-xl">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-gold-500">
              ...
              <div>
                ...
                <p className="text-sm text-gold-400 font-bold">@AqBoxing</p>
              </div>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group block bg-gradient-to-br from-purple-900/30 to-pink-900/30 rounded-lg p-12 text-center min-h-[600px] flex flex-col items-center justify-center border-2 border-purple-600/30 hover:border-purple-500 transition-all duration-300 hover:scale-[1.02]"
            >
              ...
              <h4 className="text-3xl font-black text-white mb-4 uppercase tracking-tight group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-yellow-400 group-hover:via-pink-500 group-hover:to-purple-600 transition-all">
                Follow Us on Instagram
              </h4>

              <p className="text-gray-300 text-lg font-bold mb-8 max-w-md">
                Training moments, fight highlights, and behind-the-scenes action from the ring.
              </p>

              <div className="px-10 py-4 bg-gradient-to-r from-purple-600 to-pink-600 group-hover:from-purple-500 group-hover:to-pink-500 text-white font-black text-lg uppercase tracking-wider transition-all duration-300 shadow-2xl border-2 border-purple-800 group-hover:border-purple-400 inline-flex items-center gap-3">
              ...
              <p className="text-gray-500 text-sm mt-8 font-bold">@AqBoxing</p>
            </a>
          </div>
        </div>
        ...
        <div className="text-center bg-gradient-to-br from-maroon-950 to-black p-10 border-4 border-gold-500 shadow-2xl">
          <h3 className="text-3xl font-black text-white mb-3 uppercase tracking-tight">
            Join the <span className="text-gold-500">Fight</span>
          </h3>
          <p className="text-gray-300 mb-2 font-bold text-lg">
            Be part of our story! Tag us in your posts and use
          </p>
          <p className="text-2xl font-black text-gold-400 mb-6">
            #AquinasBoxing
          </p>
