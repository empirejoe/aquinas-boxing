      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-block mb-4 px-6 py-2 bg-gradient-to-r from-maroon-50 to-gold-100 rounded-full shadow-sm">
            <span className="text-maroon-600 font-semibold text-sm tracking-wide">About Us</span>
          </div>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-4">
            The <span className="text-maroon-600">Program</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg relative overflow-hidden group hover:shadow-xl transition-shadow">
            ...
            <div className="absolute top-0 right-0 w-20 h-20 bg-maroon-100/50 rounded-bl-full group-hover:scale-110 transition-transform duration-500" />

            <h3 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-maroon-400 to-maroon-700 flex items-center justify-center flex-shrink-0">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p className="border-l-4 border-gold-400 pl-4 bg-gray-50 py-2 rounded-r-lg">
                Since <strong className="text-maroon-600">1932</strong>, we've been forging warriors in the ring and leaders in life.
                Every jab, every round, every drop of sweat builds character that lasts a lifetime.
              </p>
              <p className="border-l-4 border-gold-400 pl-4 bg-gray-50 py-2 rounded-r-lg">
                Our program demands <strong className="text-maroon-600">discipline</strong>,
                teaches <strong className="text-maroon-600">respect</strong>, and
                rewards <strong className="text-maroon-600">heart</strong>.
          ...
          {/* Mission Bouts */}
          <div className="bg-gradient-to-br from-maroon-50 to-white p-8 shadow-lg rounded-2xl relative overflow-hidden border border-gold-200">
            {/* Corner accent */}
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-maroon-400 via-gold-500 to-maroon-700 rounded-t-2xl" />
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p className="border-l-4 border-gold-500 pl-4 bg-white py-2 rounded-r-lg">
                Every March since <strong className="text-maroon-600">1932</strong>, the best of Aquinas step into the ring
                for something bigger than themselves. The <strong className="text-maroon-600">Mission Bouts</strong> aren't
                just about winning—they're about giving back.
              </p>
              <p className="border-l-4 border-gold-500 pl-4 bg-white py-2 rounded-r-lg">
                Proceeds support the <strong className="text-maroon-600">Basilian Fathers' mission work</strong> in Colombia
            ...
            <div className="grid grid-cols-3 gap-4 mt-8 pt-6 border-t border-gold-200">
              <div className="text-center">
                <div className="text-4xl font-bold bg-gradient-to-br from-maroon-500 to-maroon-700 bg-clip-text text-transparent">
                  90+
                </div>
        ...
        <div className="mt-16 text-center bg-white p-10 rounded-2xl shadow-lg relative overflow-hidden border border-gray-200">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-maroon-50/50 via-transparent to-transparent" />

          <h3 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4 relative z-10">
            Got What It <span className="text-maroon-600">Takes?</span>
          </h3>
          ...
          <a
            ...
            className="relative inline-block px-10 py-4 bg-gradient-to-r from-maroon-500 to-maroon-700 hover:from-maroon-600 hover:to-gold-700 text-white font-semibold text-lg rounded-lg transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 z-10"
          >
            Learn More
          </a>
        </div>
