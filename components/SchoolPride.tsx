      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-block mb-4 px-6 py-2 bg-gradient-to-r from-maroon-50 to-gold-100 rounded-full shadow-sm">
            <span className="text-maroon-600 font-semibold text-sm tracking-wide">Aquinas Institute</span>
          </div>
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 text-gray-900">
            More Than Boxing,
            <br />
            It's an <span className="text-maroon-600">Aquinas</span> Education
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 relative overflow-hidden group border border-gray-200">
            ...
            <div className="w-16 h-16 bg-gradient-to-br from-maroon-400 to-maroon-700 rounded-xl flex items-center justify-center mb-6 relative z-10 shadow-md">
        ...
        {/* Stats Banner */}
        <div className="bg-gradient-to-br from-maroon-50 to-gold-100 rounded-2xl p-8 mb-12 shadow-lg border border-gold-200">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-5xl md:text-6xl font-bold bg-gradient-to-br from-maroon-500 to-maroon-700 bg-clip-text text-transparent mb-2">98%</div>
            ...
            <div className="border-l border-r border-gold-200">
              <div className="text-5xl md:text-6xl font-bold bg-gradient-to-br from-maroon-500 to-maroon-700 bg-clip-text text-transparent mb-2">$2M+</div>
              <div className="text-xs md:text-sm font-medium text-gray-600">Scholarships</div>
            </div>
            <div>
              <div className="text-5xl md:text-6xl font-bold bg-gradient-to-br from-maroon-500 to-maroon-700 bg-clip-text text-transparent mb-2">15:1</div>
              <div className="text-xs md:text-sm font-medium text-gray-600">Student Ratio</div>
            </div>
            <div className="border-l border-gold-200">
              <div className="text-5xl md:text-6xl font-bold bg-gradient-to-br from-maroon-500 to-maroon-700 bg-clip-text text-transparent mb-2">90+</div>
        ...
        <div className="text-center bg-white p-12 rounded-2xl shadow-lg border border-gray-200 relative overflow-hidden">
          ...
          <h3 className="text-3xl sm:text-4xl font-bold mb-4 relative z-10 text-gray-900">
            Ready to Join the <span className="text-maroon-600">Fight?</span>
          </h3>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center relative z-10">
            <a
              ...
              className="px-10 py-4 bg-gradient-to-r from-maroon-500 to-maroon-700 hover:from-maroon-600 hover:to-gold-700 text-white font-semibold text-lg rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg"
            >
              Learn Admissions
            </a>
            <a
